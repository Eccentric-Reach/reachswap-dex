...
const TokenModalRow: React.FC<TokenModalRowProps> = ({
  ...
  // FIXED: Determine if we should show price
  const shouldShowPrice = token.price !== undefined && token.price > 0;
    ...
    >
      ...
      <div className="text-right flex-shrink-0 flex items-center space-x-2">
        <div>
          ...
          {/* FIXED: Only show price if it's valid and greater than 0 */}
