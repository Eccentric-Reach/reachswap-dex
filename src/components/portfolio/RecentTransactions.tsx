                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500 dark:text-gray-400 flex items-center space-x-2">
                      ...
                      {tx.routedThroughSphynx && (
                        <span className="inline-flex items-center space-x-1 text-xs bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 px-1.5 py-0.5 rounded-full">
                          <Zap className="w-2.5 h-2.5" />
                          <span>via Sphynx</span>
                        </span>
                      )}
                      <button 
