        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-12 text-center">
          ...
          <div className="mt-8 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
            ...
            <p className="text-sm text-blue-600 dark:text-blue-400 mt-2">
              Get live data from Loop Network RPC and track your DeFi positions
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          disabled={isLoading}
          className={`flex items-center justify-center w-10 h-10 bg-orange-500 hover:bg-orange-600 disabled:bg-orange-400 text-white rounded-lg transition-colors ${
      ...
      <div className="text-center">
        <div className="inline-flex items-center space-x-2 text-xs text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-800 px-3 py-2 rounded-full">
